...
func (s *Repository) InventoryEntries(ctx context.Context, characterID string) ([]InventoryItem, error) {
...
func (s *Repository) InventoryEntry(ctx context.Context, characterID, entryID string) (InventoryEntry, error) {
...
func (s *Repository) AddInventory(ctx context.Context, characterID, definitionID string, quantity int) (InventoryEntry, error) {
	c, err := s.Character(ctx, characterID)
	if err != nil {
		return InventoryEntry{}, err
	}
...
func (s *Repository) UpdateInventoryEntry(ctx context.Context, characterID, entryID string, fields map[string]any) (InventoryEntry, error) {
	c, err := s.Character(ctx, characterID)
	if err != nil {
		return InventoryEntry{}, err
	}
...
func (s *Repository) DeleteInventoryEntry(ctx context.Context, characterID, entryID, policy string) error {
	if _, err := s.Character(ctx, characterID); err != nil {
		return err
	}

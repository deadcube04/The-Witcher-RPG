...
func (s *Repository) Skills(ctx context.Context, characterID, systemID string, attrs domain.Attributes) ([]domain.Skill, error) {
	var rows []skillRow
...
func (s *Repository) UpdateSkills(ctx context.Context, characterID, systemID string, updates []domain.SkillUpdate) error {

...
func (a *API) listAttacks(c *gin.Context) {
	...
	v, err := a.attackEntries.List(c.Request.Context(), id)
	if err != nil {
...
func (a *API) addAttack(c *gin.Context) {
	...
	v, err := a.attackEntries.Add(c.Request.Context(), id, in.DefinitionID, in.SourceInventoryEntryID)
	if err != nil {
...
func (a *API) addAttackFromInventory(c *gin.Context) {
	...
	v, err := a.attackEntries.AddFromInventory(c.Request.Context(), id, in.InventoryEntryID)
	if err != nil {
		a.failure(c, err, "CONTENT_NOT_FOUND")
		return
	}
...
func (a *API) updateAttack(c *gin.Context) {
	...
	v, err := a.attackEntries.Update(c.Request.Context(), id, entryID, fields)
	if err != nil {
		a.failure(c, err, "CONTENT_NOT_FOUND")
		return
	}
...
func (a *API) deleteAttack(c *gin.Context) {
	...
	if err := a.attackEntries.Delete(c.Request.Context(), id, entryID); err != nil {
		a.failure(c, err, "CONTENT_NOT_FOUND")
		return
	}
	c.Status(204)

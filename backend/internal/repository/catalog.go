...
func (s *Store) InventoryCatalog(ctx context.Context, systemID, query, kind string) ([]InventoryDefinition, error) {
...
func (s *Store) RitualCatalog(ctx context.Context, systemID, query, element string) ([]RitualDefinition, error) {
	var rows []ritualRow
...
func (s *Store) AttackCatalog(ctx context.Context, systemID, query, source string) ([]AttackDefinition, error) {
	var rows []attackRow
...
func (s *Store) OrdemSystemID(ctx context.Context) (string, error) {
	var id string

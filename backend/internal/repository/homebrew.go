...
func (s *Store) homebrewItem(ctx context.Context, id string) (InventoryDefinition, error) {
	...
	return InventoryDefinition{}, ErrNotFound
}
func (s *Store) CreateInventoryHomebrew(ctx context.Context, in domain.InventoryInput) (InventoryDefinition, error) {
	systemID, err := s.OrdemSystemID(ctx)
	if err != nil {
		return InventoryDefinition{}, err
	}
...
func (s *Store) UpdateInventoryHomebrew(ctx context.Context, id string, in domain.InventoryInput) (InventoryDefinition, error) {
	systemID, err := s.OrdemSystemID(ctx)
	if err != nil {
		return InventoryDefinition{}, err
	}
...
func (s *Store) DeleteInventoryHomebrew(ctx context.Context, id string) error {
...
func (s *Store) homebrewRitual(ctx context.Context, id string) (RitualDefinition, error) {
	systemID, err := s.OrdemSystemID(ctx)
	if err != nil {
	...
	return RitualDefinition{}, ErrNotFound
}
func (s *Store) CreateRitualHomebrew(ctx context.Context, in domain.RitualInput) (RitualDefinition, error) {
	systemID, err := s.OrdemSystemID(ctx)
	if err != nil {
		return RitualDefinition{}, err
	}
...
func (s *Store) UpdateRitualHomebrew(ctx context.Context, id string, in domain.RitualInput) (RitualDefinition, error) {
	err := s.DB.WithContext(ctx).Transaction(func(tx *gorm.DB) error {
		var count int64
...
func (s *Store) DeleteRitualHomebrew(ctx context.Context, id string) error {
	return s.DB.WithContext(ctx).Transaction(func(tx *gorm.DB) error {
		var count int64
		if err := tx.Table("core.ability_definition").Where("id=? AND owner_user_id=?", id, s.UserID).Count(&count).Error; err != nil {
			return err
...
func (s *Store) homebrewAttack(ctx context.Context, id string) (AttackDefinition, error) {
	systemID, err := s.OrdemSystemID(ctx)
	if err != nil {
	...
	return AttackDefinition{}, ErrNotFound
}
func (s *Store) attackSkillID(tx *gorm.DB, in domain.AttackInput, systemID string) (string, error) {
	var id string
	if in.SkillID != nil {
		id = *in.SkillID
		var count int64
...
func (s *Store) CreateAttackHomebrew(ctx context.Context, in domain.AttackInput) (AttackDefinition, error) {
	systemID, err := s.OrdemSystemID(ctx)
	if err != nil {
		return AttackDefinition{}, err
	}
...
func (s *Store) UpdateAttackHomebrew(ctx context.Context, id string, in domain.AttackInput) (AttackDefinition, error) {
	systemID, err := s.OrdemSystemID(ctx)
	if err != nil {
		return AttackDefinition{}, err
	}
...
func (s *Store) DeleteAttackHomebrew(ctx context.Context, id string) error {
	return s.DB.WithContext(ctx).Transaction(func(tx *gorm.DB) error {
		var count int64
		if err := tx.Table("ordem.attack_definition").Where("id=? AND owner_user_id=?", id, s.UserID).Count(&count).Error; err != nil {
			return err

...
const databaseSchema = z.strictObject({ version: z.literal(1), user: userSchema, preferences: preferencesSchema,
  systems: z.array(systemSchema), campaigns: z.array(campaignSchema), characters: z.array(characterSchema) })
...
export class MockRepository {
  ...
  constructor(storage: Persistence) { this.storage = storage }
  read(): MockDatabase {

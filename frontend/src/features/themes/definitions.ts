...
export const defaultTheme = {
	...
	classes:
		"[--accent:#9fe87b] [--canvas:#0b1217] [--panel:#14212a] [--ink:#e1f2f6] [--edge:#335967] font-mono",
	decoration:
...
export const themes: ThemeDefinition[] = [
	{
		...
		classes:
			"[--accent:#ff8676] [--canvas:#160d0e] [--panel:#241214] [--ink:#ffe9e3] [--edge:#603236] font-sans",
		decoration:
	...
	},
	{
		...
		classes:
			"[--accent:#c7c0a3] [--canvas:#10120f] [--panel:#1d201a] [--ink:#edeedf] [--edge:#4e5343] font-serif",
		decoration:
	...
	},
	{
		...
		classes:
			"[--accent:#f0c66c] [--canvas:#17150f] [--panel:#252116] [--ink:#f5edda] [--edge:#655431] font-serif",
		decoration:
	...
	},
	{
		...
		classes:
			"[--accent:#c77dff] [--canvas:#100817] [--panel:#20102b] [--ink:#f5e9ff] [--edge:#70418c] font-mono",
		decoration:
	...
	},
	{
		...
		classes:
			"[--accent:#e0dfda] [--canvas:#101012] [--panel:#19191d] [--ink:#f1f0ed] [--edge:#45454e] font-sans",
		decoration:

	...
	return (
		<RpgCard>
			<p className="mb-5 font-mono text-xs text-(--accent)">
				{systemName} /{" "}
				{campaign.status === "active" ? "Em andamento" : "Arquivada"}
			</p>
			...
			<p className="my-5 line-clamp-3 min-h-16 text-sm leading-6 opacity-75">
				{campaign.description || "Uma história ainda por escrever."}
			</p>
